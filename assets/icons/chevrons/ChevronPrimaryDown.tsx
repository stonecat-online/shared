...
import StyledSVG from './ChevronPrimaryDown.styles';

const ChevronPrimaryDown = (props: any) => {
  const { color } = props;
  return (
    // @ts-ignore
    <StyledSVG width="32px" height="32px" color={color}>
      ...
      <g
        id="icon/down-chevron/32px/black"
        stroke="none"
        strokeWidth="2"
        fill="none"
        fillRule="evenodd"
      >
        ...
        <path
          ...
          fill="#191919"
          fill-rule="nonzero"
          transform="translate(16.003450, 16.000000) rotate(90.000000) translate(-16.003450, -16.000000) "
        ></path>
      </g>
    </StyledSVG>
  );
...
export default ChevronPrimaryDown;
